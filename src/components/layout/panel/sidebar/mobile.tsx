...
export function SidebarMobile({ menuType }: SidebarMobileProps) {
  ...
  return (
    <Transition.Root show={menuOpened} as={Fragment}>
      <Dialog as='div' className='relative z-50 lg:hidden' onClose={toggleMenuOpened}>
        <Transition.Child
          as={Fragment}
            ...
            <Dialog.Panel className='relative mr-16 flex w-full max-w-xs flex-1'>
              ...
              >
                <div className='absolute left-full top-0 flex w-16 justify-center pt-5'>
                  <button type='button' className='-m-2.5 p-2.5' onClick={() => toggleMenuOpened(false)}>
